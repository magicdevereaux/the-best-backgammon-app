// JS port of backend/game/game_logic.py, used for client-side move staging
// (legal-move highlighting and tentative board updates before a turn is
// confirmed). Coordinate conventions match the backend:
